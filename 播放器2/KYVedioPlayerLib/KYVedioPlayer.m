...
//    [self.playOrPauseBtn setImage:imgM forState:UIControlStateNormal];
    ...
    [self.playOrPauseBtn setImage:[UIImage imageNamed:@"video_pause_nor"] forState:UIControlStateNormal];
    [self.playOrPauseBtn setImage:[UIImage imageNamed:@"video_play_nor"] forState:UIControlStateSelected];
    ...
    [self.progressSlider setThumbImage:[UIImage imageNamed:@"ic_dot"] forState:UIControlStateNormal];
    ...
    [self.fullScreenBtn setImage:[UIImage imageNamed:@"video_fullscreen_nor"] forState:UIControlStateNormal];
    [self.fullScreenBtn setImage:[UIImage imageNamed:@"video_smallscreen_nor"] forState:UIControlStateSelected];
    [self.bottomView addSubview:self.fullScreenBtn];

    //左边时间
    self.leftTimeLabel = [self creatLabelWtihTextColor:[UIColor whiteColor] backgroundColor:[UIColor clearColor] fontSize:11];
    self.leftTimeLabel.textAlignment = NSTextAlignmentLeft;
    

    //右边时间
    self.rightTimeLabel = [self creatLabelWtihTextColor:[UIColor whiteColor] backgroundColor:[UIColor clearColor] fontSize:11];
...
- (UILabel *)creatLabelWtihTextColor:(UIColor *)color backgroundColor:(UIColor *)backgroundColor fontSize:(CGFloat)fontSize
{
...
- (void)setURLString:(NSString *)URLString{
    ...
    if (self.closeBtnStyle==CloseBtnStylePop) {
        [_closeBtn setImage:[UIImage imageNamed:@"video_nav_back_nor"] forState:UIControlStateNormal];
        [_closeBtn setImage:[UIImage imageNamed:@"video_nav_back_nor"] forState:UIControlStateSelected];
        [_closeBtn setImage:[UIImage imageNamed:@"video_nav_back_hl"] forState:UIControlStateHighlighted];

    }else{
        [_closeBtn setImage:[UIImage imageNamed:@"ic_close"] forState:UIControlStateNormal];
        [_closeBtn setImage:[UIImage imageNamed:@"ic_close"] forState:UIControlStateSelected];
        [_closeBtn setImage:[UIImage imageNamed:@"ic_close_p"] forState:UIControlStateHighlighted];
    }
}
/**
 *  判断是否是网络视频 还是 本地视频
